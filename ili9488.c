...
static int ili9488_init(struct device *dev, struct mipi_dbi *mipi,
			const struct ili9488_display_quirks *quirks,
			 ...
			 struct drm_crtc_state *crtc_state)
{
	...
	mipi_dbi_command(mipi, ILI9488_CMD_DISPLAY_FUNCTION_CONTROL, 0x02, 0x02);
...
static const struct ili9488_display_quirks ertft_quirks = {
	.pipe_funcs = {
		.enable		= ertft_enable,
